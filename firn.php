...
$sql="INSERT INTO `registration` (`name`,`fname`,`aadhar`,`address`,`pincode`,`email`,`phone`,`complaint`,`reference`) VALUES ('$name','$fname','$aadhar','$address','$pincode','$email','$phone','$complaint','$reg')";
